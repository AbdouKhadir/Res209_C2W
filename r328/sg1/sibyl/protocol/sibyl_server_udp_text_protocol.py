...
class SibylServerUdpTextProtocol(DatagramProtocol):
    ...
    def datagramReceived(self, datagram, host_port):
        ...
        """
        date=datagram.decode('utf-8').split(":")[0]
        question=datagram.decode('utf-8').split(":")[1].split("\r\n")[0]
        response="{0}: ".format(date) + self.sibylServerProxy.generateResponse(question) +"\r\n";        
        self.transport.write(response.encode('utf-8'),(host_port[0], host_port[1]))
        pass
