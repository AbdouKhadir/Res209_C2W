...
class SibylClientUdpBinProtocol(DatagramProtocol):
    ...
    def sendRequest(self, line):
        ...
        temps = time.time()
        print('call of sendRequest')
        buff = struct.pack('IH{0}s'.format(n), temps, n+4+2, line.encode('utf-8'))  
    ...
    def datagramReceived(self, datagram, host):
        ...
        """
        message=datagram[6:].decode('utf-8')
        

    
        self.clientProxy.responseReceived(message)
